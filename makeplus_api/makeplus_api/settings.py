...
# Password validation
# Custom validators: Only require 8+ characters and at least one number
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'events.validators.MinimumLengthValidator',
        'OPTIONS': {
            'min_length': 8,
        }
    },
    {
        'NAME': 'events.validators.ContainsNumberValidator',
    },
]
