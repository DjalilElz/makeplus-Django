...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={'ordering': ['-assigned_at'], 'verbose_name': 'Communication Committee Member', 'verbose_name_plural': 'Communication Committee Members'},
        ),
        migrations.AlterModelOptions(
            name='eposteremailtemplate',
            options={'ordering': ['template_type'], 'verbose_name': 'Communication Email Template', 'verbose_name_plural': 'Communication Email Templates'},
        ),
        migrations.AlterModelOptions(
            name='epostersubmission',
            options={'ordering': ['-submitted_at'], 'verbose_name': 'Communication Submission', 'verbose_name_plural': 'Communication Submissions'},
        ),
        migrations.AlterModelOptions(
            name='epostervalidation',
            options={'ordering': ['-validated_at'], 'verbose_name': 'Communication Validation', 'verbose_name_plural': 'Communication Validations'},
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='eposter_code',
            field=models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='Code de Communication'),
        ),
