    ...
    class Meta:
        ...
        widgets = {
            ...
            'location_url': forms.URLInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., https://maps.google.com/?q=Centre+des+Congres+Alger'
            }),
...
class EventEditForm(forms.ModelForm):
    """Form for editing existing events (matches EventDetailsForm fields)"""
...
class PayableItemForm(forms.ModelForm):
    """Form for creating/editing payable items - Simple form with only name and price"""
    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'e.g., Dinner, Access Badge, Materials'
            }),
            'price': forms.NumberInput(attrs={
                'class': 'form-control',
                'step': '0.01',
    ...
    def save(self, commit=True):
        ...
        instance.item_type = 'other'  # Custom items are 'other' type
        instance.session = None  # Custom items are not linked to sessions
